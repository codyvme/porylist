...
function AboutModal({ onClose }: { onClose: () => void }) {
  return (
    <Modal onClose={onClose} maxWidth="max-w-md">
      <div className="p-6">
        <button
          className="absolute right-4 top-4 text-muted-foreground hover:text-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring rounded"
          onClick={onClose}
          aria-label="Close"
        >
          <X className="h-4 w-4" />
        ...
        <div className="space-y-4 text-sm text-muted-foreground">
          ...
          <div className="flex gap-2">
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="flex items-center gap-2 rounded-lg border border-border px-4 py-2.5 text-sm font-medium text-foreground transition-colors hover:bg-muted focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring"
            >
        ...
        <header className="flex-shrink-0 border-b border-[hsl(193_60%_18%/0.6)] bg-[hsl(193_90%_9%)] pt-[env(safe-area-inset-top)]">
          <div className="flex items-center gap-3 px-4">
            ...
            <button
              ...
              className="sm:hidden rounded-md p-2 text-slate-400 hover:bg-white/10 hover:text-white transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white/50"
            ...
            <div className="ml-auto flex items-center gap-1">
              ...
              {user ? (
                ...
                <button
                  ...
                  className="rounded-full px-3 py-1.5 text-sm font-medium text-slate-300 hover:bg-slate-700 hover:text-white transition-colors whitespace-nowrap focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white/50"
                >
                  Sign in
                </button>
              )}
