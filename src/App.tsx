        ...
        <div className="space-y-4 text-sm text-muted-foreground">
          ...
          <div className="flex gap-2">
            <button
              disabled
              title="Coming soon..."
              className="flex flex-1 items-center gap-2 rounded-lg border border-border px-4 py-2.5 text-sm font-medium text-foreground opacity-50 cursor-not-allowed"
            >
